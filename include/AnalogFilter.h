// AnalogFilter.h - ver 2.0
// Headder part of Analog Filter Design Class
// Separate AnalogFiltet.h to Analoghilter.h and AnalogFilter.cpp 
// Working with AnalogFilter.cpp and ALP_BUTT.cpp, ALP_CHEB.cpp, ALP_ICHE, ALP_ELLI, ABP_BUTT
...
class AnalogFilter 
{
	...
	void time_response(int n, double r_min, double r_max, std::complex<double> pole[], std::complex<double> amp[],
						double t_start, double t_end, double i_min, double i_max, const std::string& title);
	...
	// Frequency transform from LPF to BPF.
	...
	// Frequency transform from LPF to HPF.
	void a_lpftohpf(std::complex<double> pole[], std::complex<double> zero[]);
	void hpf_butterworth(std::complex<double> pole[], std::complex<double> zero[]);
	void hpf_chebyshev(std::complex<double> pole[], std::complex<double> zero[]);
	void hpf_inv_chebyshev(std::complex<double> pole[], std::complex<double> zero[]);
	void hpf_elliptic(std::complex<double> pole[], std::complex<double> zero[]);

	// Frequency transform from LPF to BEF.
	void a_lpftobef(std::complex<double> pole[], std::complex<double> zero[]);
	void bef_butterworth(std::complex<double> pole[], std::complex<double> zero[]);
	void bef_chebyshev(std::complex<double> pole[], std::complex<double> zero[]);
	void bef_inv_chebyshev(std::complex<double> pole[], std::complex<double> zero[]);
	void bef_elliptic(std::complex<double> pole[], std::complex<double> zero[]);

	// Save information. 
    int write_AnalogFilter(int impn, int stpn, std::complex<double> pole[], std::complex<double> zero[]);
